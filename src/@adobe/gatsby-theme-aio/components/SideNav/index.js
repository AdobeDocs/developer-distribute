        ...
        return (
          <li
            ...
            className={classNames([
              ...
              {
                "is-selected":
                  selectedPages[selectedPages.length - 1] === page &&
                  isSelected,
              },
            ])}
          >
                  ...
                  if (page?.pages?.length && !page.header) {
                    if (expandedPages.includes(pageHref)) {
                      setExpandedPages((pages) =>
                        pages.filter((href) => href !== pageHref)
                      );
                    } else {
                  ...
                  <ChevronRight
                    css={css`
                      ...
                      transition: transform
                        ...
                        ease-in-out;
                      ${expandedPages.includes(pageHref) &&
                  ...
                  <ChevronRight
                    css={css`
                      ...
                      transition: transform
                        var(--spectrum-global-animation-duration-100)
                        ease-in-out;
                      ${expandedMenus.includes(pageHref) &&
                      `transform: rotate(90deg);`}
                    `}
                  />
                ) : null}
