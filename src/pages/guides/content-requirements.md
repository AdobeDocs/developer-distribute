...
description: Adobe  content requirements and prohibited content policies to ensure user safety and maintain acceptable standards.
contributors:
...
In the interests of user safety and acceptable standards, plugins must not:
