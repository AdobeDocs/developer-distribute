...
There is a [predefined set of guidelines](https://developer-stage.adobe.com/developer-distribution/creative-cloud/docs/guides/branding-guidelines) that are published by Adobe periodically for the use of Adobe assets and product icons. It is expected that developers strictly adhere to these guidelines.
...
- We expect you to thoroughly read the [Adobe Branding Guidelines](https://developer-stage.adobe.com/developer-distribution/creative-cloud/docs/guides/branding-guidelines) with due diligence and follow the guidelines exactly. Failure to do so will result in rejection during the review process.
